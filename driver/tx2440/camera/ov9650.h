...
/* for tx2440_camif_dev->state field. */
enum
{
...
/* for tx2440_camif_dev->cmdcode field. */
enum
{
	CAMIF_CMD_NONE	= 0,
...
/* opened file handle.*/
struct tx2440_camif_fh
{
	/* the camif */
	struct tx2440_camif_dev	* dev;
