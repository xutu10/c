...
.LFB974:
	...
	movl	4(%rax), %ebx	# this_1(D)->count, D.20949
	movq	-24(%rbp), %rax	# this, tmp64
	movl	(%rax), %eax	# this_1(D)->value, D.20949
	movl	%eax, %esi	# D.20949,
	movl	$_ZSt4cout, %edi	#,
	call	_ZNSolsEi	#
	movl	%ebx, %esi	# D.20949,
	movq	%rax, %rdi	# D.20950,
	call	_ZNSolsEi	#
