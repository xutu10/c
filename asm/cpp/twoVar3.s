...
.LFB977:
	...
	movl	4(%rax), %ebx	# this_1(D)->count, D.20966
	movq	-24(%rbp), %rax	# this, tmp64
	movl	(%rax), %eax	# this_1(D)->value, D.20966
	movl	%eax, %esi	# D.20966,
	movl	$_ZSt4cout, %edi	#,
	call	_ZNSolsEi	#
	movl	%ebx, %esi	# D.20966,
...
.L8:
	...
	movq	%rax, %rdi	# tmp74,
	call	_ZN6OutputD1Ev	#
	movq	%rbx, %rax	# tmp70, D.20968
	movq	%rax, %rdi	# D.20968,
.LEHB1:
	call	_Unwind_Resume	#
.LEHE1:
.L9:
