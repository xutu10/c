...
.LFB977:
	...
	movl	4(%rax), %ebx	# this_1(D)->count, D.21031
	movq	-24(%rbp), %rax	# this, tmp64
	movl	(%rax), %eax	# this_1(D)->value, D.21031
	movl	%eax, %esi	# D.21031,
	movl	$_ZSt4cout, %edi	#,
	call	_ZNSolsEi	#
	movl	%ebx, %esi	# D.21031,
	movq	%rax, %rdi	# D.21032,
	call	_ZNSolsEi	#
...
.LEHB0:
	call	_ZNSolsEPKv	#
	movl	$.LC0, %esi	#,
	movq	%rax, %rdi	# D.21034,
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc	#
	leaq	-32(%rbp), %rdx	#, tmp76
	movq	%rdx, %rsi	# tmp76,
	movq	%rax, %rdi	# D.21035,
	call	_ZNSolsEPKv	#
	movl	$.LC0, %esi	#,
	movq	%rax, %rdi	# D.21034,
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc	#
...
.L8:
	...
	movq	%rax, %rdi	# tmp93,
	call	_ZN6OutputD1Ev	#
	movq	%rbx, %rax	# tmp89, D.21033
	movq	%rax, %rdi	# D.21033,
.LEHB1:
	call	_Unwind_Resume	#
.LEHE1:
.L9:
