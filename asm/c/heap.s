...
# options passed:  -imultiarch x86_64-linux-gnu heap.c -mtune=generic
...
.LFB2:
	...
	movl	$6, -12(%rbp)	#, a
	leaq	-12(%rbp), %rax	#, tmp62
	movq	%rax, -8(%rbp)	# tmp62, pa
	movq	-8(%rbp), %rax	# pa, tmp63
	movl	(%rax), %eax	# *pa_1, D.2698
	movl	%eax, %esi	# D.2698,
	movl	$.LC0, %edi	#,
	movl	$0, %eax	#,
	call	printf	#
