...
# options passed:  -imultiarch x86_64-linux-gnu assign.c -mtune=generic
...
.LFB0:
	...
	movl	$2, -12(%rbp)	#, a
	movl	-12(%rbp), %eax	# a, tmp64
	addl	%eax, %eax	# tmp63
	movl	%eax, -8(%rbp)	# tmp63, b
	movl	-8(%rbp), %eax	# b, tmp69
	movl	-12(%rbp), %edx	# a, tmp70
	addl	%edx, %eax	# tmp70, tmp68
	movl	%eax, -4(%rbp)	# tmp68, c
	movl	$0, %eax	#, D.2187
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret
