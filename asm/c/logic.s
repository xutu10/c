...
# options passed:  -imultiarch x86_64-linux-gnu logic.c -mtune=generic
...
.LFB0:
	...
	je	.L3	#,
.L2:
	movl	-4(%rbp), %eax	# b, tmp61
	addl	%eax, -8(%rbp)	# tmp61, a
	jmp	.L4	#
.L3:
	cmpl	$0, -8(%rbp)	#, a
	je	.L4	#,
	...
	imull	-4(%rbp), %eax	# b, tmp62
	movl	%eax, -8(%rbp)	# tmp62, a
.L4:
	movl	$0, %eax	#, D.1739
	popq	%rbp	#
	.cfi_def_cfa 7, 8
