...
# options passed:  -imultiarch x86_64-linux-gnu heap2.c -mtune=generic
...
.LFB2:
	...
	movl	$4, %edi	#,
	call	malloc	#
	movq	%rax, -8(%rbp)	# tmp61, pa
	movq	-8(%rbp), %rax	# pa, tmp62
	movl	-12(%rbp), %edx	# a, tmp63
	movl	%edx, (%rax)	# tmp63, *pa_2
	movq	-8(%rbp), %rax	# pa, tmp64
	movq	%rax, %rdi	# tmp64,
	call	free	#
	movl	$0, %eax	#, D.2696
	leave
